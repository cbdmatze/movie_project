...
def main():
    """
    The main function to run the Movie App. It accepts a command-line argumnt
    ...
    the MovieApp with that storage.
    ...
    parser.add_argument("storage_file", help="Path to the storage file (e.g., john.json, ashley.csv.)")
