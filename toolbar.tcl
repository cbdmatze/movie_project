...
# Comment out or remove the check for the "widgetDemo" variable
...
# Replace positionWindow with wm geometry
wm geometry $w 400x300+100+100
...
proc addSeeDismiss {buttons w} {
    ttk::button $buttons.see -text "See" -command [list $w.txt insert end "See Pressed\n"]
    ttk::button $buttons.dismiss -text "Dismiss" -command [list $w destroy]
    grid $buttons.see $buttons.dismiss -sticky ew
    return $buttons
}
